...
class TestFeatureBuilder:
    ...
    def test_hour_of_day_extraction(self):
        ...
        test_row = pd.Series({"timestamp": "2023-01-01 15:30:00", "amount": 100.0})
    ...
    def test_day_of_week_extraction(self):
        ...
        test_row = pd.Series({"timestamp": "2023-01-01 15:30:00", "amount": 100.0})  # Sunday = 6
    ...
    def test_missing_data_handling(self):
        ...
        test_row = pd.Series({"amount": None, "timestamp": "2023-01-01 15:30:00"})
